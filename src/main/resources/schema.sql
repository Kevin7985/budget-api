...
CREATE TABLE IF NOT EXISTS accounts (
    ...
    CONSTRAINT fk_user_for_account FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS categories (
    ...
    CONSTRAINT fk_user_for_category FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS operations (
    ...
    CONSTRAINT fk_user_for_operation FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE
);